    ...
    <header className=" flex justify-between items-center">
      <Link to="/" className="flex items-center gap-1">
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="w-8 h-8 -rotate-90 stroke-primary"
        >
          <path
            strokeLinecap="round"
        ...
        <span className="font-bold text-xl">clbnb</span>
      </Link>
      <div className="flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-150">
        <div className="px-1">Anywhere</div>
        <div className="border-l border-gray-300" />
        <div className="px-1">Any Week</div>
        <div className="border-l border-gray-300" />
        <div className="px-1 pr-2">Add Guests</div>
        <button className="bg-primary text-white p-1 rounded-full" type="button">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
